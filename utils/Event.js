...
(function (ch) {
	 ...
	 */
	ch.utils.Event.prototype.observe = function (sName, fnClosure) {
	 ...
	 * @param {Function} fnClosure Closure to be executed
	 */
	ch.utils.Event.prototype.leave = function (sName, fnClosure) {
		var iIndex, aEvents;
	 ...
	 */
	ch.utils.Event.prototype.say = function (sName, aArguments) {
